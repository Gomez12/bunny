...
registry.register("read_file", "Read the contents of a file at a given path.", READ_FILE_SCHEMA, readFileHandler);
registry.register("list_dir", "List directory entries at a given path.", LIST_DIR_SCHEMA, listDirHandler);
registry.register(
  "edit_file",
