...
- [ADR 0036 — Social handles + businesses](./adr/0036-social-handles-and-businesses.md)
- [ADR 0037 — Scripts subsystem](./adr/0037-scripts-subsystem.md)
- [ADR 0038 — News feeds and site monitor](./adr/0038-news-feeds-and-site-monitor.md)
- [ADR 0039 — Code-project secrets](./adr/0039-code-project-secrets.md)
- [ADR 0040 — Diagrams subsystem](./adr/0040-diagrams-subsystem.md)
- [ADR 0041 — Diary subsystem](./adr/0041-diary-subsystem.md)
- [ADR 0042 — Electron client](./adr/0042-electron-client.md)
- [ADR 0043 — Planning subsystem](./adr/0043-planning-subsystem.md)
