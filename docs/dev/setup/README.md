...
Four pages, read top-to-bottom on day one.

1. [**setup.md**](./setup.md) — prerequisites, install, run the CLI, run the web UI, run the Electron client.
2. [**architecture-tour.md**](./architecture-tour.md) — the three design principles, one-turn data flow, top-level code map. Gives you a mental model before you touch anything.
